...
export const SKILLS = {
  ...
  ArcaneCrackedSeed: { id: 'ArcaneCrackedSeed', name: 'Arcane Seed', category: 'arcane' },
  ...
  EnemyDeath: { id: 'EnemyDeath', name: 'Death Blades', category: 'arcane' },
  ...
  FireAtom: { id: 'FireAtom', name: 'Fire Orb', category: 'fire' },
  FireBeam: { id: 'FireBeam', name: 'Fire Beam', category: 'fire' },
  FlameShowerMeteor: { id: 'FlameShowerMeteor', name: 'Rain of Flames', category: 'fire' },
  ...
  PoisonCloud: { id: 'PoisonCloud', name: 'Toxicity', category: 'arcane' },
