...
export const STAT_REGISTRY = {
  ...
  mageryCritChance: {
    ...
    patterns: [
      ...
      'Damage.Magery.CriticalChance%',
      'Magery.CriticalChance%6',
      'Magery.CriticalChance%',
  ...
  archeryCritChance: {
    ...
    patterns: [
      ...
      'Damage.Archery.CriticalChance%',
      'Archery.CriticalChance%6',
      'Archery.CriticalChance%',
  ...
  unarmedCritDamage: {
    ...
    patterns: [
      ...
      'Damage.Fists.CriticalDamage%',
      'Fists.CriticalDamage%6',
      'Fists.CriticalDamage%',
  ...
  unarmedCritChance: {
    ...
    patterns: [
      ...
      'Damage.Fists.CriticalChance%',
      'Fists.CriticalChance%6',
      'Fists.CriticalChance%',
  ...
  scytheCritDamage: {
    ...
    patterns: [
      ...
      'Damage.Scythe.CriticalDamage%',
      'Scythe.CriticalDamage%6',
      'Scythe.CriticalDamage%',
      'ScytheCriticalDamage%6',
      'ScytheCriticalDamage%',
  ...
  scytheCritChance: {
    ...
    patterns: [
      ...
      'Damage.Scythe.CriticalChance%',
      'Scythe.CriticalChance%6',
      'Scythe.CriticalChance%',
      'ScytheCriticalChance%6',
      'ScytheCriticalChance%',
